...
const INTELLIGENCE_CONTEXT_MENU_ITEMS = [
        ...
        <motion.form className={styles.intelligencePromptCard} onSubmit={handleSubmit} layoutId="ai-composer" layout>
          ...
          <div className={styles.intelligencePromptControls}>
            <div className={styles.intelligenceContextLeft}>
              <div className={styles.intelligenceContextMenuWrap}>
                <button
                  ref={contextMenuButtonRef}
                  type="button"
                  className={`${styles.intelligenceGhostAction} ${isContextMenuOpen ? styles.intelligenceGhostActionActive : ''}`}
                ...
                {isContextMenuOpen ? (
                  <div
                    ref={contextMenuRef}
                    className={styles.intelligenceContextMenu}
                    role="menu"
                    aria-label="Adicionar contexto ao chat"
                  >
                    {INTELLIGENCE_CONTEXT_MENU_ITEMS.map(({ id, label, Icon }) => {
                      const active = contextChips.some((c) => c.type === id)
                      return (
                        <button
                          key={id}
                          type="button"
                          className={`${styles.intelligenceContextMenuItem} ${active ? styles.intelligenceContextMenuItemActive : ''}`}
                          role="menuitem"
                          onClick={() => {
                        ...
                        >
                          <span className={styles.intelligenceContextMenuItemIcon} aria-hidden="true"><Icon /></span>
                          <span className={styles.intelligenceContextMenuItemLabel}>{label}</span>
                          {active ? <span className={styles.intelligenceContextMenuItemCheck} aria-hidden="true"><CheckIcon /></span> : null}
                        </button>
                      )
                    })}

                    <div className={styles.intelligenceContextMenuDivider} role="separator" />

                    <div className={styles.intelligenceContextSubmenuWrap}>
                      <button
                        type="button"
                        className={styles.intelligenceContextMenuItem}
                        role="menuitem"
                        aria-haspopup="menu"
                        aria-expanded={isPluginsMenuOpen}
                        onClick={() => setIsPluginsMenuOpen((v) => !v)}
                      >
                        <span className={styles.intelligenceContextMenuItemIcon} aria-hidden="true"><PlugIcon /></span>
                        <span className={styles.intelligenceContextMenuItemLabel}>Integrações</span>
                        <span className={`${styles.intelligenceContextMenuItemChevron} ${isPluginsMenuOpen ? styles.intelligenceContextMenuItemChevronOpen : ''}`} aria-hidden="true">
                          <ChevronIcon />
                        </span>
                      </button>
                      ...
                      {isPluginsMenuOpen ? (
                        <div
                          className={styles.intelligenceContextSubmenu}
                          role="menu"
                          ...
                          {INTELLIGENCE_PLUGIN_OPTIONS.map(({ id, label, Logo }) => {
                            ...
                            return (
                              <button
                                key={id}
                                type="button"
                                className={`${styles.intelligenceContextSubmenuItem} ${active ? styles.intelligenceContextMenuItemActive : ''}`}
                                role="menuitem"
                                onClick={() => {
                              ...
                              >
                                <span className={styles.intelligenceContextPluginLogo} aria-hidden="true"><Logo /></span>
                                <span>{label}</span>
                                {active ? <span className={styles.intelligenceContextMenuItemCheck} aria-hidden="true"><CheckIcon /></span> : null}
                              </button>
                            )
              ...
              {contextChips.length > 0 ? (
                <div className={styles.intelligenceContextChips} role="group" aria-label="Contexto adicionado">
                  {contextChips.map((chip) => (
                    <div key={chip.id} className={styles.intelligenceContextChip} data-kind={chip.kind}>
                      <span className={styles.intelligenceContextChipIcon} aria-hidden="true"><chip.ChipIcon /></span>
                      <span className={styles.intelligenceContextChipLabel}>{chip.label}</span>
                      <button
                        type="button"
                        className={styles.intelligenceContextChipRemove}
