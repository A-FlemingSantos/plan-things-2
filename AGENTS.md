...
This project is indexed by GitNexus as **plan-things-2** (5831 symbols, 13839 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
