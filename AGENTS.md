...
This project is indexed by GitNexus as **plan-things-2** (3986 symbols, 9484 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
