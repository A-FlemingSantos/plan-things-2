...
This project is indexed by GitNexus as **plan-things-2** (3638 symbols, 8525 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
