...
This project is indexed by GitNexus as **plan-things-2** (5912 symbols, 13984 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
