...
This project is indexed by GitNexus as **plan-things-2** (6598 symbols, 15133 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
