...
This project is indexed by GitNexus as **plan-things-2** (3112 symbols, 7375 relationships, 264 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
