...
This project is indexed by GitNexus as **plan-things-2** (5783 symbols, 13281 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
