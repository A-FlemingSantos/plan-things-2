...
This project is indexed by GitNexus as **plan-things-2** (6795 symbols, 15429 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
